...
# Configuration
SRC_DIR = "/mnt/usb/source"
DST_DIR = "/mnt/usb/destination"
...
<body>
<h2>[WebUI Backup]Comparison Report</h2>
<h3>Filters</h3>
<button class="filter-button" onclick="filterTable('All')">Show All</button>
<button class="filter-button" onclick="filterTable('Same')">Show Same</button>
<button class="filter-button" onclick="filterTable('Missing')">Show Missing</button>
...
def generate_reports():
    ...
    generate_file_list(SRC_DIR, SRC_FILE, f"[WebUI Backup] Files in {SRC_DIR}")
    generate_file_list(DST_DIR, DST_FILE, f"[WebUI Backup] Files in {DST_DIR}")
